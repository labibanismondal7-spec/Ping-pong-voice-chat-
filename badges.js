...
const BADGE_CATALOG = [
    ...
    // "Seller" / "Official" profile tags (2026-08-22 request): admin-only
    // send/remove, shown right next to the VIP badge on the profile screens
    // (own profile, other's profile, room seat-tap sheet) — NOT the seat
    // itself. Client renders these at a fixed 18px height (matching
    // .vip-badge/.svip-tag-img exactly, per the request), so profileSize
    // here is only used as a fallback/reference, not read by the client's
    // dedicated renderer for these two ids.
    { id: "agency_tag", name: "Agency Tag", imageUrl: "/images/badges/active-agency.png", seatSize: 18, profileSize: 18 },
    { id: "seller_tag", name: "Seller Tag", imageUrl: "/images/badges/seller_tag.png", seatSize: 18, profileSize: 18 },
    { id: "official_tag", name: "Official Tag", imageUrl: "/images/badges/official_tag.png", seatSize: 18, profileSize: 18 }
];
