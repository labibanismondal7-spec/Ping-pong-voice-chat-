 ...
 */
const REQUIRED_PRODUCTION = ['ADMIN_USERNAME','ADMIN_PASSWORD','METRICS_TOKEN','DATABASE_URL','REDIS_URL'];
const OPTIONAL = ['CORS_ORIGINS','LIVEKIT_URL','LIVEKIT_API_KEY','LIVEKIT_API_SECRET','TURN_URL','TURN_USERNAME','TURN_CREDENTIAL'];
