/* PingPong — ISO country + international calling-code registry.
 * 249 ISO-3166-1 alpha-2 territories are included. Phone login uses E.164
 * canonical numbers while preserving the legacy 10-digit Indian user keys.
 */
"use strict";
...
const PHONE_COUNTRIES = [
  ...
  { id: "AS", name: "American Samoa", dialCode: "+1" },
  { id: "AD", name: "Andorra", dialCode: "+376" },
  { id: "AO", name: "Angola", dialCode: "+244" },
  { id: "AI", name: "Anguilla", dialCode: "+1" },
  { id: "AQ", name: "Antarctica", dialCode: "+672" },
  { id: "AG", name: "Antigua and Barbuda", dialCode: "+1" },
  ...
  { id: "BS", name: "Bahamas", dialCode: "+1" },
  { id: "BB", name: "Barbados", dialCode: "+1" },
  { id: "BY", name: "Belarus", dialCode: "+375" },
  { id: "BE", name: "Belgium", dialCode: "+32" },
  { id: "BZ", name: "Belize", dialCode: "+501" },
  { id: "BJ", name: "Benin", dialCode: "+229" },
  { id: "BM", name: "Bermuda", dialCode: "+1" },
  { id: "BT", name: "Bhutan", dialCode: "+975" },
  { id: "BO", name: "Bolivia, Plurinational State of", dialCode: "+591" },
  { id: "BQ", name: "Bonaire, Sint Eustatius and Saba", dialCode: "+599" },
  { id: "BA", name: "Bosnia and Herzegovina", dialCode: "+387" },
  { id: "BW", name: "Botswana", dialCode: "+267" },
  { id: "BV", name: "Bouvet Island", dialCode: "+47" },
  ...
  { id: "CV", name: "Cabo Verde", dialCode: "+238" },
  { id: "KH", name: "Cambodia", dialCode: "+855" },
  { id: "CM", name: "Cameroon", dialCode: "+237" },
  { id: "KY", name: "Cayman Islands", dialCode: "+1" },
  ...
  { id: "CD", name: "Congo, The Democratic Republic of the", dialCode: "+243" },
  ...
  { id: "CW", name: "Curaçao", dialCode: "+599" },
  { id: "CY", name: "Cyprus", dialCode: "+357" },
  { id: "CZ", name: "Czechia", dialCode: "+420" },
  { id: "CI", name: "Côte d'Ivoire", dialCode: "+225" },
  { id: "DK", name: "Denmark", dialCode: "+45" },
  { id: "DJ", name: "Djibouti", dialCode: "+253" },
  { id: "DM", name: "Dominica", dialCode: "+1" },
  { id: "DO", name: "Dominican Republic", dialCode: "+1" },
  ...
  { id: "SZ", name: "Eswatini", dialCode: "+268" },
  ...
  { id: "TF", name: "French Southern Territories", dialCode: "+262" },
  ...
  { id: "GD", name: "Grenada", dialCode: "+1" },
  { id: "GP", name: "Guadeloupe", dialCode: "+590" },
  { id: "GU", name: "Guam", dialCode: "+1" },
  { id: "GT", name: "Guatemala", dialCode: "+502" },
  { id: "GG", name: "Guernsey", dialCode: "+44" },
  ...
  { id: "HM", name: "Heard Island and McDonald Islands", dialCode: "+672" },
  { id: "VA", name: "Holy See (Vatican City State)", dialCode: "+39" },
  ...
  { id: "MS", name: "Montserrat", dialCode: "+1" },
  ...
  { id: "MK", name: "North Macedonia", dialCode: "+389" },
  { id: "MP", name: "Northern Mariana Islands", dialCode: "+1" },
  { id: "NO", name: "Norway", dialCode: "+47" },
  { id: "PW", name: "Palau", dialCode: "+680" },
  { id: "PS", name: "Palestine, State of", dialCode: "+970" },
  ...
  { id: "PN", name: "Pitcairn", dialCode: "+870" },
  { id: "PL", name: "Poland", dialCode: "+48" },
  { id: "PT", name: "Portugal", dialCode: "+351" },
  { id: "PR", name: "Puerto Rico", dialCode: "+1" },
  { id: "RO", name: "Romania", dialCode: "+40" },
  { id: "RU", name: "Russian Federation", dialCode: "+7" },
  { id: "RW", name: "Rwanda", dialCode: "+250" },
  { id: "RE", name: "Réunion", dialCode: "+262" },
  { id: "BL", name: "Saint Barthélemy", dialCode: "+590" },
  { id: "SH", name: "Saint Helena, Ascension and Tristan da Cunha", dialCode: "+290" },
  { id: "KN", name: "Saint Kitts and Nevis", dialCode: "+1" },
  { id: "LC", name: "Saint Lucia", dialCode: "+1" },
  { id: "MF", name: "Saint Martin (French part)", dialCode: "+590" },
  { id: "PM", name: "Saint Pierre and Miquelon", dialCode: "+508" },
  { id: "VC", name: "Saint Vincent and the Grenadines", dialCode: "+1" },
  ...
  { id: "SX", name: "Sint Maarten (Dutch part)", dialCode: "+1" },
  ...
  { id: "GS", name: "South Georgia and the South Sandwich Islands", dialCode: "+500" },
  ...
  { id: "TW", name: "Taiwan, Province of China", dialCode: "+886" },
  ...
  { id: "TT", name: "Trinidad and Tobago", dialCode: "+1" },
  { id: "TN", name: "Tunisia", dialCode: "+216" },
  { id: "TM", name: "Turkmenistan", dialCode: "+993" },
  { id: "TC", name: "Turks and Caicos Islands", dialCode: "+1" },
  { id: "TV", name: "Tuvalu", dialCode: "+688" },
  { id: "TR", name: "Türkiye", dialCode: "+90" },
  { id: "UG", name: "Uganda", dialCode: "+256" },
  { id: "UA", name: "Ukraine", dialCode: "+380" },
  { id: "UM", name: "United States Minor Outlying Islands", dialCode: "+1" },
  { id: "UY", name: "Uruguay", dialCode: "+598" },
  { id: "UZ", name: "Uzbekistan", dialCode: "+998" },
  { id: "VU", name: "Vanuatu", dialCode: "+678" },
  { id: "VE", name: "Venezuela, Bolivarian Republic of", dialCode: "+58" },
  { id: "VN", name: "Viet Nam", dialCode: "+84" },
  { id: "VG", name: "Virgin Islands, British", dialCode: "+1" },
  { id: "VI", name: "Virgin Islands, U.S.", dialCode: "+1" },
  { id: "WF", name: "Wallis and Futuna", dialCode: "+681" },
  { id: "EH", name: "Western Sahara", dialCode: "+212" },
  { id: "YE", name: "Yemen", dialCode: "+967" },
  { id: "ZM", name: "Zambia", dialCode: "+260" },
  { id: "ZW", name: "Zimbabwe", dialCode: "+263" },
  { id: "AX", name: "Åland Islands", dialCode: "+358" }
];

const BY_ID = Object.create(null);
for (const c of PHONE_COUNTRIES) BY_ID[c.id] = c;

function normalizeNationalNumber(value) {
  return String(value == null ? "" : value).replace(/\D/g, "");
}

function toE164(countryId, nationalNumber) {
  const c = BY_ID[String(countryId || "").toUpperCase()];
  const digits = normalizeNationalNumber(nationalNumber);
  if (!c || !digits) return null;
  const full = String(c.dialCode).replace(/\D/g, "") + digits.replace(/^0+/, "");
  if (full.length < 7 || full.length > 15) return null;
  return "+" + full;
}

module.exports = { PHONE_COUNTRIES, BY_ID, normalizeNationalNumber, toE164 };
